...
class TestTransitionsSectionRuleSet(object):
        ...
        [
            (
                ...
                [
                    ...
                    # Test to ensure transitions using False as a condition are captured.
                    ValidationResult(
                        rule="UnreachableTransitionViolation",
                        severity=Severity.CRITICAL,
                        message='The transition "Wait,FALSE,SomeFailure" is unreachable due to a previous transition from "Wait" having a boolean condition.',
                        file="process.ini",
                        section="transitions",
                        line=31,
                    ),
                    ...
                    ValidationResult(
                        rule="UnreachableTransitionViolation",
                        severity=Severity.WARNING,
                        message='The transition "Wait,FALSE,SomeFailure" will never be matched.',
                        file="process.ini",
                        section="transitions",
                        line=31,
                    ),
            ...
            (
                ...
                [
                    ...
                    # Valid as the username is used in the prompt file, which is missing in this test.
                    ValidationResult(
                        rule="UnusedParameterViolation",
                        severity=Severity.WARNING,
                        message='The parameter "username" has been validated but is not used.',
    ...
    def test_transitions_section_rule_set(
        ...
        :param prompts_file: Path to the prompt file to use for the test case.
